// app/dashboard/guardian/claim-student/page.tsx
// Redesigned claim student page with modern UI

import { requireRole } from "@/lib/supabase/session"
import { isGuardianProfileComplete } from "@/lib/utils/guardian"
import { redirect } from "next/navigation"
import Link from "next/link"
import ClaimStudentFlow from "@/components/guardian/claim-student-flow"

interface ClaimStudentPageProps {
  searchParams: Promise<{ matchId?: string }>
}

export default async function ClaimStudentPage({
  searchParams,
}: ClaimStudentPageProps) {
  ...
  if (!matchId) {
    redirect("/dashboard/guardian/add-student")
  }
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-[#f8f7ff] via-white to-[#f0eeff] dark:from-[#0a0a1a] dark:via-[#0d0d1a] dark:to-[#0f0f24] px-4 py-8 md:py-12">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mb-8">
          <Link 
            href="/dashboard/guardian/add-student"
        ...
        <div className="relative">
          ...
          <div className="relative bg-white/80 dark:bg-[#13132b]/80 backdrop-blur-xl rounded-2xl border border-gray-100/50 dark:border-white/8 shadow-2xl shadow-[#6c63ff]/5 overflow-hidden">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                    Submit a request to link this student to your account.
                    An administrator will review and verify your claim.
                  </p>
                </div>
            ...
            <div className="px-6 py-6">
              <ClaimStudentFlow matchId={matchId} />
            </div>
          </div>
        </div>
      </div>
