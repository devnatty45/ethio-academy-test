// app/dashboard/branch/teacher-assignments/page.tsx
// Purpose: Branch Admin — Teacher Assignment (assign teachers to subjects per section)
import {
  requireRole,
...
import TeacherAssignmentClient from "@/components/admin/teacher-assignment-client"
...
export default async function TeacherAssignmentPage() {
  ...
  // Active teachers approved for this branch
      ...
      <div className="mx-auto max-w-5xl space-y-8">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            {branch?.name} branch — assign a teacher to each subject per section
          </p>
        </div>
