// app/dashboard/master/student-merge/page.tsx
// Redesigned student merge page with modern UI
...
import StudentMergeTool from "@/components/admin/student-merge-tool"

export default async function StudentMergePage() {
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Search for two duplicate student profiles and merge them.
                The older STU ID (lower number) is recommended as the
                surviving record. All enrollments, documents, and guardian
                links are transferred atomically.
              </p>
            </div>
          </div>
