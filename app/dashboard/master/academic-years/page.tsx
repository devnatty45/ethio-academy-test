// app/dashboard/master/academic-years/page.tsx
// Redesigned academic year management page with modern UI
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Create and manage academic years. Only one year can be OPEN at a time.
                Opening a year requires grades, capacities, fees, and document rules to be configured first.
              </p>
            </div>
          </div>
