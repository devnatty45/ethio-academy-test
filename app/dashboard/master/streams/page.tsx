// app/dashboard/master/streams/page.tsx
// Redesigned stream management page with modern UI
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Streams apply exclusively to Chereta branch, Grades 11 and 12.
                They cannot be assigned to any other branch.
              </p>
            </div>
          </div>
