// app/dashboard/master/branch-grade-stream-configs/page.tsx
// Redesigned stream configuration page with modern UI
...
import BranchGradeStreamConfigGrid from "@/components/admin/branch-grade-stream-config-grid"

export default async function BranchGradeStreamConfigPage() {
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Configure which streams are active for Grade 11 and Grade 12
                at Chereta branch per academic year.
              </p>
            </div>
          </div>
