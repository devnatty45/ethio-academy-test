// app/dashboard/master/guardian-merge/page.tsx
// Redesigned guardian merge page with modern UI
...
import GuardianMergeTool from "@/components/admin/guardian-merge-tool"

export default async function GuardianMergePage() {
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white tracking-tight">
                Guardian Account Merge Tool
              </h1>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                For guardians who accidentally created two Google accounts.
                All student links are transferred to the surviving account.
                The source account is permanently deactivated.
              </p>
            </div>
          </div>
