// app/dashboard/master/claim-requests/page.tsx
// Redesigned claim requests page with modern UI
...
import ClaimRequestsClient from "@/components/admin/claim-requests-client"
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white tracking-tight">
                Student Claim Requests
              </h1>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Review guardians claiming ownership of existing student records.
                Approved claims create a permanent student link.
              </p>
            </div>
          </div>
