// app/dashboard/master/sms/page.tsx
// Redesigned failed SMS page with modern UI
...
import FailedSmsClient from "@/components/admin/failed-sms-client"

export default async function FailedSmsPage() {
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                View all SMS messages that failed after 3 attempts.
                Re-queue individually or in bulk.
              </p>
            </div>
          </div>
