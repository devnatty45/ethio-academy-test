// app/dashboard/master/document-requirement-rules/page.tsx
// Redesigned document requirement rules page with modern UI
...
import DocumentRequirementRules from "@/components/admin/document-requirement-rules"

export default async function DocumentRequirementRulesPage() {
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Configure which documents are required per student category.
                Deactivated rules no longer apply to new enrollments but are
                preserved on historical records. Exam certificate rules
                define which grades trigger fresh certificate uploads.
              </p>
            </div>
          </div>
