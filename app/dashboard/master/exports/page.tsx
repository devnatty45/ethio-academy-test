// app/dashboard/master/exports/page.tsx
// Redesigned export tools page with modern UI
...
import ExportToolsClient from "@/components/admin/export-tools-client"

export default async function ExportToolsPage() {
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Download CSV reports for enrolled students, payments,
                waitlist state, capacity utilization, and billing summary.
