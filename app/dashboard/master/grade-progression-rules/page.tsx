// app/dashboard/master/grade-progression-rules/page.tsx
// Redesigned grade progression rules page with modern UI
...
import GradeProgressionRules from "@/components/admin/grade-progression-rules"

export default async function GradeProgressionRulesPage() {
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Define where students go next year. Each rule maps one grade-branch combination to another.
                For example: Grade 8 at Asko → Grade 9 at Chereta.
              </p>
            </div>
          </div>
