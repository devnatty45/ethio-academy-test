// app/dashboard/master/enrollments/override/page.tsx
// Redesigned enrollment override page with modern UI
...
import EnrollmentOverrideClient from "@/components/admin/enrollment-override-client"

export default async function EnrollmentOverridePage() {
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white tracking-tight">
                Enrollment Status Override
              </h1>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Search for an enrollment by student name or STU ID, then
                manually override its status. MFA is required. All changes
          ...
          <div className="relative">
            ...
            <div className="relative bg-white/80 dark:bg-[#13132b]/80 backdrop-blur-xl rounded-2xl border border-gray-100/50 dark:border-white/8 shadow-2xl shadow-[#6c63ff]/5 overflow-hidden">
              ...
              <div className="px-6 py-6">
                <EnrollmentOverrideClient years={years ?? []} />
              </div>
            </div>
          </div>
        </div>
