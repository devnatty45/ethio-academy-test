// app/dashboard/master/grades/page.tsx
// Redesigned grade management page with modern UI
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                View all grades sorted by level. Add new grades or toggle active status.
                Level order determines sort order throughout the system.
              </p>
            </div>
          </div>
