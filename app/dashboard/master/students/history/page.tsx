// app/dashboard/master/students/history/page.tsx
// Redesigned student history page with modern UI
...
import StudentHistoryClient from "@/components/admin/student-history-client"
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Search any student by name or STU ID to view their complete
                enrollment history, documents, transitions, and academic
                results across all years and branches.
              </p>
            </div>
          </div>
